...
const fields = [
  ...
  { name: "年龄", type: "NUMBER", required: false, options: [] },
  ...
  { name: "刑期起始日期", type: "DATE", required: true, options: [] },
  { name: "刑期截止日期", type: "DATE", required: true, options: [] },
  {
    name: "出生日",
    type: "NUMBER",
    required: false,
...
const content =
  "本表用于入监登记。带红色星号的项目为必填；年龄会根据出生年月自动计算，出生年月使用年月选择器，出生日为可选的 1–31 日数字；刑期须分别选择起始日期和截止日期。体态特征按实际情况填写，电子签名位于表格末端，管理处公章由管理员最终审批时加盖。"
